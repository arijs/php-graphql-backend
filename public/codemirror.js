var CodeMirror = (function (exports, require$$0, require$$1$2, ExecutableDefinitions) {
	'use strict';
	...
	var codemirror$1 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.assign(/*#__PURE__*/Object.create(null), codemirror$2.exports, {
		'default': codemirror
	}));
	...
	(function(mod) {
	  mod(codemirror$2.exports, searchcursor.exports, dialog.exports);
	})(function(CodeMirror) {
	...
	(function(mod) {
	  mod(codemirror$2.exports, dialog.exports);
	})(function(CodeMirror) {
	...
	(function(mod) {
	  mod(codemirror$2.exports, searchcursor.exports, matchbrackets.exports);
	})(function(CodeMirror) {
	...
	function getFieldDef$1(schema, type, fieldName) {
	    if (fieldName === require$$1$2.SchemaMetaFieldDef.name && schema.getQueryType() === type) {
	        return require$$1$2.SchemaMetaFieldDef;
	    }
	    if (fieldName === require$$1$2.TypeMetaFieldDef.name && schema.getQueryType() === type) {
	        return require$$1$2.TypeMetaFieldDef;
	    }
	    if (fieldName === require$$1$2.TypeNameMetaFieldDef.name && require$$0.isCompositeType(type)) {
	        return require$$1$2.TypeNameMetaFieldDef;
	    }
	...
	const collectFragmentDefs = (op) => {
	    ...
	    if (op) {
	        require$$0.visit(require$$0.parse(op, {
	...
	function getAutocompleteSuggestions(schema, queryText, cursor, contextToken, fragmentDefs) {
	    ...
	    const typeInfo = getTypeInfo$2(schema, token.state);
	    ...
	    if (kind === RuleKinds.VARIABLE && step === 1) {
	        const namedInputType = require$$0.getNamedType(typeInfo.inputType);
	...
	function getSuggestionsForFieldNames(token, typeInfo, schema) {
	    if (typeInfo.parentType) {
	        ...
	        if (require$$0.isCompositeType(parentType)) {
	            fields.push(require$$0.TypeNameMetaFieldDef);
	        }
	        if (parentType === schema.getQueryType()) {
	            fields.push(require$$0.SchemaMetaFieldDef, require$$0.TypeMetaFieldDef);
	        }
	...
	function getSuggestionsForInputValues(token, typeInfo, queryText, schema) {
	    ...
	    if (namedInputType instanceof require$$0.GraphQLEnumType) {
	    ...
	    else if (namedInputType === require$$0.GraphQLBoolean) {
	        return hintList(token, queryVariables.concat([
	            {
	                label: 'true',
	                detail: String(require$$0.GraphQLBoolean),
	                documentation: 'Not false.',
	                kind: CompletionItemKind.Variable,
	                type: require$$0.GraphQLBoolean,
	            },
	            {
	                label: 'false',
	                detail: String(require$$0.GraphQLBoolean),
	...
	function getSuggestionsForImplements(token, tokenState, schema, documentText, typeInfo) {
	    ...
	    const schemaInterfaces = objectValues(typeMap).filter(require$$0.isInterfaceType);
	        ...
	        if (state.name) {
	            ...
	            if (state.kind === RuleKinds.NAMED_TYPE &&
	                ...
	                if (typeInfo.interfaceDef) {
	                    ...
	                    typeInfo.interfaceDef = new require$$0.GraphQLInterfaceType({
	                        ...interfaceConfig,
	                        interfaces: [
	                            ...interfaceConfig.interfaces,
	                            type ||
	                                new require$$0.GraphQLInterfaceType({ name: state.name, fields: {} }),
	                        ],
	                    });
	                }
	                    ...
	                    typeInfo.objectTypeDef = new require$$0.GraphQLObjectType({
	                        ...objectTypeConfig,
	                        interfaces: [
	...
	function getSuggestionsForFragmentTypeConditions(token, typeInfo, schema, _kind) {
	    let possibleTypes;
	    if (typeInfo.parentType) {
	        if (require$$0.isAbstractType(typeInfo.parentType)) {
	            const abstractType = require$$0.assertAbstractType(typeInfo.parentType);
	        ...
	        const typeMap = schema.getTypeMap();
	        possibleTypes = objectValues(typeMap).filter(require$$0.isCompositeType);
	    }
	    return hintList(token, possibleTypes.map(type => {
	        const namedType = require$$0.getNamedType(type);
	        return {
	            label: String(type),
	...
	function getSuggestionsForFragmentSpread(token, typeInfo, schema, queryText, fragmentDefs) {
	    ...
	    const relevantFrags = fragments.filter(frag => typeMap[frag.typeCondition.name.value] &&
	        ...
	        require$$0.isCompositeType(typeInfo.parentType) &&
	        require$$0.isCompositeType(typeMap[frag.typeCondition.name.value]) &&
	        require$$0.doTypesOverlap(schema, typeInfo.parentType, typeMap[frag.typeCondition.name.value]));
	...
	function getSuggestionsForVariableDefinition(token, schema, _kind) {
	    ...
	    const inputTypes = objectValues(inputTypeMap).filter(require$$0.isInputType);
	...
	function getTypeInfo$2(schema, tokenState) {
	    let argDef;
	    let argDefs;
	    let directiveDef;
	    let enumValue;
	        ...
	        switch (state.kind) {
	            ...
	            case RuleKinds.ALIASED_FIELD: {
	                if (!type || !state.name) {
	                    ...
	                    fieldDef = parentType
	                        ? getFieldDef$1(schema, parentType, state.name)
	                        : null;
	            ...
	            case RuleKinds.SELECTION_SET:
	                parentType = require$$0.getNamedType(type);
	                break;
	            ...
	            case RuleKinds.INTERFACE_DEF:
	                if (state.name) {
	                    objectTypeDef = null;
	                    interfaceDef = new require$$0.GraphQLInterfaceType({
	                        name: state.name,
	                        interfaces: [],
	                        fields: {},
	                    });
	            ...
	            case RuleKinds.OBJECT_TYPE_DEF:
	                if (state.name) {
	                    interfaceDef = null;
	                    objectTypeDef = new require$$0.GraphQLObjectType({
	                        name: state.name,
	                        interfaces: [],
	                        fields: {},
	                    });
	                    ...
	                    switch (state.prevState.kind) {
	                        ...
	                        case RuleKinds.ALIASED_FIELD: {
	                            ...
	                            const field = parentType
	                                ? getFieldDef$1(schema, parentType, name)
	                                : null;
	                            if (!field) {
	                                argDefs = null;
	                                break;
	            ...
	            case RuleKinds.ARGUMENT:
	                ...
	                break;
	            case RuleKinds.ENUM_VALUE:
	                const enumType = require$$0.getNamedType(inputType);
	                enumValue =
	                    enumType instanceof require$$0.GraphQLEnumType
	                        ? find$1(enumType.getValues(), (val) => val.value === state.name)
	                        : null;
	                break;
	            case RuleKinds.LIST_VALUE:
	                const nullableType = require$$0.getNullableType(inputType);
	                inputType =
	                    nullableType instanceof require$$0.GraphQLList ? nullableType.ofType : null;
	                break;
	            case RuleKinds.OBJECT_VALUE:
	                const objectType = require$$0.getNamedType(inputType);
	                objectFieldDefs =
	                    objectType instanceof require$$0.GraphQLInputObjectType
	...
	const getFragmentDependencies = (operationString, fragmentDefinitions) => {
	    ...
	    let parsedOperation;
	    try {
	        parsedOperation = require$$0.parse(operationString, {
	...
	const getFragmentDependenciesForAST = (parsedOperation, fragmentDefinitions) => {
	    ...
	    require$$0.visit(parsedOperation, {
	...
	function validateWithCustomRules(schema, ast, customRules, isRelayCompatMode) {
	    const rules = require$$0.specifiedRules.filter(rule => {
	        if (rule === require$$0.NoUnusedFragmentsRule || rule === ExecutableDefinitions.ExecutableDefinitions) {
	            return false;
	        }
	        if (isRelayCompatMode && rule === require$$0.KnownFragmentNamesRule) {
	            return false;
	        }
	        return true;
	    });
	    ...
	    const errors = require$$0.validate(schema, ast, rules);
	    return errors.filter(error => {
	        if (error.message.indexOf('Unknown directive') !== -1 && error.nodes) {
	            const node = error.nodes[0];
	            if (node && node.kind === require$$0.Kind.DIRECTIVE) {
	...
	async function getDefinitionQueryResultForNamedType(text, node, dependencies) {
	    ...
	    return {
	        definitions,
	        queryRange: definitions.map(_ => getRange$1(text, node)),
	    };
	}
	async function getDefinitionQueryResultForFragmentSpread(text, fragment, dependencies) {
	    ...
	    return {
	        definitions,
	        queryRange: definitions.map(_ => getRange$1(text, fragment)),
	    };
	}
	function getDefinitionQueryResultForDefinitionNode(path, text, definition) {
	    return {
	        definitions: [getDefinitionForFragmentDefinition(path, text, definition)],
	        queryRange: definition.name ? [getRange$1(text, definition.name)] : [],
	    };
	}
	function getDefinitionForFragmentDefinition(path, text, definition) {
	    ...
	    return {
	        ...
	        range: getRange$1(text, definition),
	        name: name.value || '',
	        language: LANGUAGE,
	        projectRoot: path,
	    };
	            ...
	            query +=
	                '\n\n' +
	                    externalFragments.reduce((agg, node) => {
	                        agg += require$$0.print(node) + '\n\n';
	                        return agg;
	                    }, '');
	        }
	    }
	    try {
	        ast = require$$0.parse(query);
	    }
	    catch (error) {
	...
	function validateQuery(ast, schema = null, customRules, isRelayCompatMode) {
	    ...
	    const deprecationWarningAnnotations = mapCat(require$$0.findDeprecatedUsages(schema, ast), error => annotations(error, DIAGNOSTIC_SEVERITY.Warning, 'Deprecation'));
	...
	const { INLINE_FRAGMENT } = require$$0.Kind;
	function getOutline(documentText) {
	    let ast;
	    try {
	        ast = require$$0.parse(documentText);
	    }
	    catch (error) {
	        return null;
	    }
	    const visitorFns = outlineTreeConverter(documentText);
	    const outlineTrees = require$$0.visit(ast, {
	        leave(node) {
	...
	function renderTypeAnnotation$1(into, typeInfo, options, t) {
	    text$1(into, ': ');
	    renderType$1(into, typeInfo, options, t);
	}
	...
	function renderType$1(into, typeInfo, options, t) {
	    if (!t) {
	        return;
	    }
	    if (t instanceof require$$0.GraphQLNonNull) {
	        renderType$1(into, typeInfo, options, t.ofType);
	        text$1(into, '!');
	    }
	    else if (t instanceof require$$0.GraphQLList) {
	        text$1(into, '[');
	        renderType$1(into, typeInfo, options, t.ofType);
	        text$1(into, ']');
	    }
	...
	function renderDeprecation$1(into, _options, def) {
	    ...
	    text$1(into, '\n\n');
	    text$1(into, 'Deprecated: ');
	    text$1(into, reason);
	}
	function text$1(into, content) {
	    into.push(content);
	}

	const { FRAGMENT_DEFINITION, OBJECT_TYPE_DEFINITION, INTERFACE_TYPE_DEFINITION, ENUM_TYPE_DEFINITION, UNION_TYPE_DEFINITION, SCALAR_TYPE_DEFINITION, INPUT_OBJECT_TYPE_DEFINITION, SCALAR_TYPE_EXTENSION, OBJECT_TYPE_EXTENSION, INTERFACE_TYPE_EXTENSION, UNION_TYPE_EXTENSION, ENUM_TYPE_EXTENSION, INPUT_OBJECT_TYPE_EXTENSION, DIRECTIVE_DEFINITION, FRAGMENT_SPREAD, OPERATION_DEFINITION, NAMED_TYPE, } = require$$0.Kind;
	const KIND_TO_SYMBOL_KIND = {
	    [require$$0.Kind.FIELD]: SymbolKind.Field,
	    [require$$0.Kind.OPERATION_DEFINITION]: SymbolKind.Class,
	    [require$$0.Kind.FRAGMENT_DEFINITION]: SymbolKind.Class,
	    [require$$0.Kind.FRAGMENT_SPREAD]: SymbolKind.Struct,
	    [require$$0.Kind.OBJECT_TYPE_DEFINITION]: SymbolKind.Class,
	    [require$$0.Kind.ENUM_TYPE_DEFINITION]: SymbolKind.Enum,
	    [require$$0.Kind.ENUM_VALUE_DEFINITION]: SymbolKind.EnumMember,
	    [require$$0.Kind.INPUT_OBJECT_TYPE_DEFINITION]: SymbolKind.Class,
	    [require$$0.Kind.INPUT_VALUE_DEFINITION]: SymbolKind.Field,
	    [require$$0.Kind.FIELD_DEFINITION]: SymbolKind.Field,
	    [require$$0.Kind.INTERFACE_TYPE_DEFINITION]: SymbolKind.Interface,
	    [require$$0.Kind.DOCUMENT]: SymbolKind.File,
	...
	class GraphQLLanguageService {
	    ...
	    async getDiagnostics(query, uri, isRelayCompatMode) {
	        ...
	        try {
	            const queryAST = require$$0.parse(query);
	        ...
	        const dependenciesSource = fragmentDependencies.reduce((prev, cur) => `${prev} ${require$$0.print(cur.definition)}`, '');
	        source = `${source} ${dependenciesSource}`;
	        let validationAst = null;
	        try {
	            validationAst = require$$0.parse(source);
	        }
	        catch (error) {
	            return [];
	        }
	...
	var graphql_language_service_interface_1$1 = require$$1$1;
	var graphql_language_service_utils_1 = require$$2;
	codemirror_1$6.default.registerHelper('hint', 'graphql', function (editor, options) {
	    ...
	    var rawResults = graphql_language_service_interface_1$1.getAutocompleteSuggestions(schema, editor.getValue(), position, token, options.externalFragments);
	    var results = {
	    ...
	    if (results && results.list && results.list.length > 0) {
	        results.from = codemirror_1$6.default.Pos(results.from.line, results.from.ch);
	        results.to = codemirror_1$6.default.Pos(results.to.line, results.to.ch);
	        codemirror_1$6.default.signal(editor, 'hasCompletion', editor, results, token);
	    }
	    return results;
	});
	...
	var graphql_language_service_interface_1 = require$$1$1;
	...
	codemirror_1$5.default.registerHelper('lint', 'graphql', function (text, options) {
	    var schema = options.schema;
	    ...
	    var results = rawResults.map(function (error) { return ({
	        ...
	        from: codemirror_1$5.default.Pos(error.range.start.line, error.range.start.character),
	        to: codemirror_1$5.default.Pos(error.range.end.line, error.range.end.character),
	    }); });
	    return results;
	});
	...
	Object.defineProperty(getTypeInfo$1, "__esModule", { value: true });
	var graphql_1$2 = require$$0__default['default'];
	var introspection_1 = require$$1__default['default'];
	var forEachState_1 = __importDefault$5(forEachState$1);
	    ...
	    forEachState_1.default(tokenState, function (state) {
	        switch (state.kind) {
	            ...
	            case 'AliasedField':
	                ...
	                break;
	            case 'SelectionSet':
	                info.parentType = info.type ? graphql_1$2.getNamedType(info.type) : null;
	                break;
	            case 'Directive':
	            ...
	            case 'Argument':
	                ...
	                break;
	            case 'EnumValue':
	                var enumType = info.inputType ? graphql_1$2.getNamedType(info.inputType) : null;
	                info.enumValue =
	                    enumType instanceof graphql_1$2.GraphQLEnumType
	                        ? find(enumType.getValues(), function (val) { return val.value === state.name; })
	                        : null;
	                break;
	            case 'ListValue':
	                var nullableType = info.inputType
	                    ? graphql_1$2.getNullableType(info.inputType)
	                    : null;
	                info.inputType =
	                    nullableType instanceof graphql_1$2.GraphQLList ? nullableType.ofType : null;
	                break;
	            case 'ObjectValue':
	                var objectType = info.inputType ? graphql_1$2.getNamedType(info.inputType) : null;
	                info.objectFieldDefs =
	                    objectType instanceof graphql_1$2.GraphQLInputObjectType
	                        ? objectType.getFields()
	                        : null;
	                break;
	            case 'ObjectField':
	...
	getTypeInfo$1.default = getTypeInfo;
	function getFieldDef(schema, type, fieldName) {
	    ...
	    if (fieldName === introspection_1.TypeNameMetaFieldDef.name && graphql_1$2.isCompositeType(type)) {
	...
	var graphql_1$1 = require$$0__default['default'];
	...
	function getEnumValueReference(typeInfo) {
	    return {
	        ...
	        type: typeInfo.inputType
	            ? graphql_1$1.getNamedType(typeInfo.inputType)
	            : undefined,
	    };
	}
	...
	codemirror_1$4.default.defineOption('info', false, function (cm, options, old) {
	    if (old && old !== codemirror_1$4.default.Init) {
	        var oldOnMouseOver = cm.state.info.onMouseOver;
	        codemirror_1$4.default.off(cm.getWrapperElement(), 'mouseover', oldOnMouseOver);
	    ...
	    if (options) {
	        ...
	        codemirror_1$4.default.on(cm.getWrapperElement(), 'mouseover', state.onMouseOver);
	    }
	});
	...
	function onMouseOver$1(cm, e) {
	    ...
	    var onMouseOut = function () {
	        codemirror_1$4.default.off(document, 'mousemove', onMouseMove);
	        codemirror_1$4.default.off(cm.getWrapperElement(), 'mouseout', onMouseOut);
	        clearTimeout(state.hoverTimeout);
	    ...
	    state.hoverTimeout = setTimeout(onHover, hoverTime);
	    codemirror_1$4.default.on(document, 'mousemove', onMouseMove);
	    codemirror_1$4.default.on(cm.getWrapperElement(), 'mouseout', onMouseOut);
	}
	...
	function showPopup(cm, box, info) {
	    ...
	    var hidePopup = function () {
	        codemirror_1$4.default.off(popup, 'mouseover', onMouseOverPopup);
	        codemirror_1$4.default.off(popup, 'mouseout', onMouseOut);
	        codemirror_1$4.default.off(cm.getWrapperElement(), 'mouseout', onMouseOut);
	    ...
	    codemirror_1$4.default.on(popup, 'mouseover', onMouseOverPopup);
	    codemirror_1$4.default.on(popup, 'mouseout', onMouseOut);
	    codemirror_1$4.default.on(cm.getWrapperElement(), 'mouseout', onMouseOut);
	}
	...
	var graphql_1 = require$$0__default['default'];
	var codemirror_1$3 = __importDefault$3(codemirror$2.exports);
	var getTypeInfo_1$1 = __importDefault$3(getTypeInfo$1);
	var SchemaReference_1$1 = SchemaReference;

	codemirror_1$3.default.registerHelper('info', 'graphql', function (token, options) {
	    ...
	    var kind = state.kind;
	    var step = state.step;
	    var typeInfo = getTypeInfo_1$1.default(options.schema, token.state);
	    if ((kind === 'Field' && step === 0 && typeInfo.fieldDef) ||
	        (kind === 'AliasedField' && step === 2 && typeInfo.fieldDef)) {
	...
	function renderQualifiedField(into, typeInfo, options) {
	    ...
	    text(into, fieldName, 'field-name', options, SchemaReference_1$1.getFieldReference(typeInfo));
	}
	function renderDirective(into, typeInfo, options) {
	    var _a;
	    var name = '@' + (((_a = typeInfo.directiveDef) === null || _a === void 0 ? void 0 : _a.name) || '');
	    text(into, name, 'directive-name', options, SchemaReference_1$1.getDirectiveReference(typeInfo));
	}
	function renderArg(into, typeInfo, options) {
	    ...
	    text(into, '(');
	    text(into, name, 'arg-name', options, SchemaReference_1$1.getArgumentReference(typeInfo));
	...
	function renderEnumValue(into, typeInfo, options) {
	    ...
	    text(into, '.');
	    text(into, name, 'enum-value', options, SchemaReference_1$1.getEnumValueReference(typeInfo));
	}
	function renderType(into, typeInfo, options, t) {
	    if (t instanceof graphql_1.GraphQLNonNull) {
	        ...
	        text(into, (t === null || t === void 0 ? void 0 : t.name) || '', 'type-name', options, SchemaReference_1$1.getTypeReference(typeInfo, t));
	    }
	}
	...
	codemirror_1$2.default.defineOption('jump', false, function (cm, options, old) {
	    if (old && old !== codemirror_1$2.default.Init) {
	        var oldOnMouseOver = cm.state.jump.onMouseOver;
	        codemirror_1$2.default.off(cm.getWrapperElement(), 'mouseover', oldOnMouseOver);
	        var oldOnMouseOut = cm.state.jump.onMouseOut;
	        codemirror_1$2.default.off(cm.getWrapperElement(), 'mouseout', oldOnMouseOut);
	        codemirror_1$2.default.off(document, 'keydown', cm.state.jump.onKeyDown);
	    ...
	    if (options) {
	        ...
	        codemirror_1$2.default.on(cm.getWrapperElement(), 'mouseover', state.onMouseOver);
	        codemirror_1$2.default.on(cm.getWrapperElement(), 'mouseout', state.onMouseOut);
	        codemirror_1$2.default.on(document, 'keydown', state.onKeyDown);
	    }
	});
	...
	function onKeyDown(cm, event) {
	    ...
	    var onKeyUp = function (upEvent) {
	        ...
	        codemirror_1$2.default.off(document, 'keyup', onKeyUp);
	        codemirror_1$2.default.off(document, 'click', onClick);
	    ...
	    codemirror_1$2.default.on(document, 'keyup', onKeyUp);
	    codemirror_1$2.default.on(document, 'click', onClick);
	...
	var getTypeInfo_1 = __importDefault$1(getTypeInfo$1);
	var SchemaReference_1 = SchemaReference;

	codemirror_1$1.default.registerHelper('jump', 'graphql', function (token, options) {
	...
	var require$$1 = /*@__PURE__*/getAugmentedNamespace(esm$2);
	...
	var graphql_language_service_parser_1 = require$$1;
	...
	giqlexApp.GraphQL,
	giqlexApp.GraphQL_Type_Introspection,
	giqlexApp.GraphQL_Validation_Rules_ExecutableDefinitions
));
